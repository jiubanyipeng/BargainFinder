    ...
    async with semaphore:
        ...
        async with pool.acquire() as conn:
            async with conn.cursor() as cur:
                # 使用参数占位符，防止SQL注入攻击
                await cur.execute(
                    'INSERT INTO your_table_name (sort, name, title, product_name, price, promotion, coupon, in_store, evaluate) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)',
                    (sort, name, title, product_name, price, promotion, coupon, in_store, evaluate))
...
async def main():
    ...
    urls = [
        'https://item.jd.com/100010602104.html',
        'https://item.jd.com/100010891770.html',
        'https://item.jd.com/100010685629.html',
        'https://item.jd.com/100011149085.html',
        'https://item.jd.com/100011149084.html',
    ]
